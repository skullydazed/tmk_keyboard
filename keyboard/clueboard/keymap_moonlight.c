...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP(
        ...
        FN9, NUBS,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,  RO,FN10,  UP, \
        CAPS,FN0,LALT,MHEN,     SPC, SPC,      HENK,RALT,RCTL,RGUI,      LEFT,DOWN,RGHT),
    /* 1: colemak */
    KEYMAP(
        ESC, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, JYEN,BSPC, INS, \
        TAB, Q,   W,   F,   P,   G,   J,   L,   U,   Y,   SCLN,LBRC,RBRC,BSLS,      DEL, \
        BSPC,A,   R,   S,   T,   D,   H,   N,   E,   I,   O,   QUOT,NUHS, ENT, \
        FN9, NUBS,Z,   X,   C,   V,   B,   K,   M,   COMM,DOT, SLSH,  RO,FN10,  UP, \
        LCTL,LALT,LGUI,MHEN,     SPC, SPC,      HENK,RGUI,RCTL, FN0,     LEFT,DOWN,RGHT),
    /* 2: experiment */
    KEYMAP(
        ESC, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, JYEN,BSPC, INS, \
        TAB, Q,   UP,  E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC,BSLS,      DEL, \
        LCTL,LEFT,DOWN,RGHT,F,   G,   Z,   X,   C,   L,   SCLN,QUOT,NUHS,ENT,  \
        FN9, NUBS,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,  RO,FN10,  UP, \
    ...
    KEYMAP(
        ...
        FN9, NUBS,Z,   X,   M,   C,   V,   K,   L,   COMM,DOT, SLSH,   RO,FN10,  UP, \
        LCTL,LALT,LGUI,MHEN,     SPC, SPC,      HENK,RGUI,RCTL, FN0,      LEFT,DOWN,RGHT),
    /* 4: fc660m Fn
     * ,-----------------------------------------------------------.   ,---.
    ...
    KEYMAP(
        ...
        TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,PSCR,SLCK,PAUS,TRNS,TRNS,TRNS,     FN4, \
    ...
    KEYMAP(
        ...
        FN9, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,FN10,TRNS, \
        TRNS,TRNS,TRNS,TRNS,     TRNS,TRNS,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS),
};
const uint16_t PROGMEM fn_actions[] = {
    ...
    [9] = ACTION_LAYER_MODS(6, MOD_LSFT),  // So that esc outputs tilde when lshift is held
    [10] = ACTION_LAYER_MODS(6, MOD_RSFT)  // So that esc outputs tilde when rshift is held
};
