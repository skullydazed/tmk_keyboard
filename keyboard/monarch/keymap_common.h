...
/* monarch keymap definition macro
 */
#define KEYMAP( \
    ...
    K40,      K42,      K44, K45, K46,           K49,                K4D, K4E,      K4G, K4H  \
) { \
    ...
    { KC_##K30, KC_##K31, KC_##K32, KC_##K33, KC_##K34, KC_##K35, KC_##K36, KC_##K37, KC_##K38, KC_##K39, KC_##K3A, KC_##K3B, KC_##K3C, KC_##K3D, KC_##K3E, KC_NO,    KC_##K3G, KC_NO,    }, \
    { KC_##K40, KC_NO,    KC_##K42, KC_NO,    KC_##K44, KC_##K45, KC_##K46, KC_NO,    KC_NO,    KC_##K49, KC_NO,    KC_NO,    KC_NO,    KC_##K4D, KC_##K4E, KC_NO,    KC_##K4G, KC_##K4H, }, \
}
